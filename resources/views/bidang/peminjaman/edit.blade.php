    ...
    <div class="row">
      <form class="col-md-12" action="">
        <div class="col-md-12 {{-- col-md-offset-2 --}} grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">Peminjaman Alsintan</h4>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Catatan Pengajuan</label>
                    <div class="col-sm-9">
              ...
              <div class="row">
                <div class="col-md-12">
                  <button type="submit" class="btn btn-success mr-2">Terima Peminjaman</button>
                  <button type="button" class="btn btn-danger mr-2">Tolak Peminjaman</button>
                  <a href="{{ route('bidang_peminjaman.index') }}" class="btn btn-secondary mr-2">Batal</a>
                </div>
              </div>
