...
@section('content')
  <div class="content-wrapper">
    <div class="row">
      <form class="col-md-12" action="{{ route('admin_alsintanpinjam.update', ['id' => $alsintan->id]) }}" method="POST">
        {{ method_field('PUT')}}
            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <a href="{{ route('admin_alsintanpinjam.index') }}" type="submit" class="btn btn-secondary mr-2">Batal</a>
                </div>
              </div>
