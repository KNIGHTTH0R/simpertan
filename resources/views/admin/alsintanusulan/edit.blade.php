        ...
        <div class="col-md-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-md-6">
                  <button type="submit" class="btn btn-success mr-2">Perbarui Alsintan</button>
                  <a href="{{ route('admin_alsintanusulan.index') }}" type="submit" class="btn btn-secondary mr-2">Batal</a>
                </div>
              </div>
