            ...
            <table class="table table-striped">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <a href="{{ route('admin_poktanuser.edit', ['id' => 'id']) }}" class="btn btn-sm btn-primary" title="Edit"><i class="fa fa-edit fa-lg"></i></a>
                    <button type="button" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#modalHapusPoktan" title="Hapus"><i class="fa fa-trash fa-lg"></i></button>
                  </td>
                </tr>
